...
void ScriptLua::Set_LogMessage( fLogMessage_t&& f ) {
  m_fLogMessage = std::move( f );
}
...
ScriptLua::mapScript_t::iterator ScriptLua::Parse( const std::string& sPath ) {
  ...
  lua_pushcfunction( lua(), lua_log_message );
  lua_setglobal( lua(), "log_message" );
...
int ScriptLua::lua_log_message( lua_State* pLua ) {
